...
var _animateElement = __webpack_require__(200);
...
var CinemaZoom = function () {
	...
	_createClass(CinemaZoom, [{
		...
		value: function createElements() {
			...
			this.image = (0, _utils.createElement)('img', 'cinema-zoom__image');
		...
		value: function onClickOriginal() {
			...
			this.loadLargeImage().then(function () {
				_this.zoomIn();
			}).catch(function () {
...
var $typed = __webpack_require__(20);
...
var toLength = __webpack_require__(26);
var toIndex = __webpack_require__(27);
var gOPN = __webpack_require__(28).f;
var dP = __webpack_require__(6).f;
var arrayFill = __webpack_require__(39);
...
if (__webpack_require__(10)) {
  ...
  var arrayFill = __webpack_require__(39);
  var arrayCopyWithin = __webpack_require__(66);
  var $DP = __webpack_require__(6);
...
__webpack_require__(5)(IteratorPrototype, __webpack_require__(42)('iterator'), function () {
  return this;
});
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(198), __webpack_require__(199)(module)))
	...
	_createClass(AnimateElement, [{
		...
		value: function animate(timestamp) {
			...
			Object.entries(this.properties).forEach(function (property) {
				...
				var newValue = startValue + (val - startValue) * ease(progress);
